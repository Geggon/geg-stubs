...
class XmlDateTimeSerializationMode(typing.SupportsInt):
    @typing.overload
    def __init__(self, value : int) -> None: ...
    @typing.overload
    def __init__(self, value : int, force_if_true: bool) -> None: ...
    ...
    # Values:
    Local : XmlDateTimeSerializationMode # 0
    Utc : XmlDateTimeSerializationMode # 1
    Unspecified : XmlDateTimeSerializationMode # 2
    RoundtripKind : XmlDateTimeSerializationMode # 3
