...
class CAEXDocument(XDocumentWrapper, IAMLFile):
    ...
    @staticmethod
    def LoadFromBinaryAsync(binary: Array_1[int], cancellationToken: CancellationToken = ..., createIndices: bool = ...) -> Task_1[CAEXDocument]: ...
    @staticmethod
    def LoadFromFile(filePath: str, createIndices: bool = ...) -> CAEXDocument: ...
    @staticmethod
    def LoadFromFileAsync(filePath: str, cancellationToken: CancellationToken = ..., createIndices: bool = ...) -> Task_1[CAEXDocument]: ...
    @staticmethod
    def LoadFromStream(inStream: Stream, createIndices: bool = ...) -> CAEXDocument: ...
    @staticmethod
    def LoadFromStreamAsync(inStream: Stream, cancellationToken: CancellationToken = ..., createIndices: bool = ...) -> Task_1[CAEXDocument]: ...
    @staticmethod
    ...
    def SaveToFileAsync(self, filename: str, prettyPrint: bool, cancellationToken: CancellationToken = ...) -> Task: ...
    def SaveToStream(self, prettyPrint: bool) -> Stream: ...
    def SaveToStreamAsync(self, prettyPrint: bool, cancellationToken: CancellationToken = ...) -> Task_1[Stream]: ...
